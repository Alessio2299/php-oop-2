<?php
  ...
  $foods = [];
  $foods[] = new Foods("Crocchette", "Foods", 8.99, 0, "Royal Canin", "Riso e Salmone", "High", false);
  $foods[] = new Foods("Bastoncini", "Foods", 1.10, 20, "Pedrigrex", "Meat", "Medium", false);

  $pesticides = [];
  $pesticides[]= new Pesticides("Collare Antipulci" , "Pesticides", 3.20, 5, "FrontLine", "Small", false);
  ...
  $toys[]= new Toys("Fune", "Toys", 3.20, 8, "Corda", true);
